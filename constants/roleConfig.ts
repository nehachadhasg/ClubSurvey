export const ROLE_CONFIG = {
  SUPERADMIN: {
    ...
    users: {
      view: 'all',
      create: 'allExceptSuperAdmin',
      edit: 'allExceptSuperAdmin',
      delete: 'allExceptSuperAdmin',
    },
  ...
  FRANCHISEADMIN: {
    settings: {
      view: 'allExceptFranchises',
      create: true,
      edit: true,
      delete: true,
    },
    users: {
      view: 'allExceptSuperAdmin',
      create: 'allExceptSuperAdminAndFranchiseAdmin',
      edit: 'allExceptSuperAdminAndFranchiseAdmin',
      delete: 'allExceptSuperAdminAndFranchiseAdmin',
    },
    translations: { view: true, create: true, edit: true, delete: true },
    surveys: {
      questionBank: { view: true, create: true, edit: true, delete: true },
  ...
  GROUPADMIN: {
    ...
    users: {
      view: 'groupManagersAndStaff',
      create: 'venueManagerAndStaff',
      edit: 'venueManagerAndStaff',
      delete: 'venueManagerAndStaff',
    },
