...
export class ClubSurveyLogin extends PlaywrightWrapper {
  ...
  public selectors = {
    ...
    imgscroller2:
      'img alt="Unlock Powerful Insights" loading="lazy" width="450" height="300" decoding="async" data-nimg="1" class="object-contain" src="/_next/static/media/loginsecond.b5f50a21.svg" style="color: transparent"',
    imgscroller3:
    ...
    clublogodashboard:
      'img alt="Large Logo" width="51" height="18" decoding="async" data-nimg="1" class="h-[17px] w-[48px]" src="/_next/static/media/largeLogo.087c4efb.svg" style="color: transparent"',
   ...
   */
  public async ClubSurveyLogin(credentials: {
    username: string;
    password: string;
  }) {
